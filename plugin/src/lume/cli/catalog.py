...
_CATALOG: list[dict] = [
    ...
    _verb("gap", "Record or list cross-repo capability gaps (gaps/<id>.json).",
          "add \"<title>\" [-c <context>] | list",
          [_pos("subcommand", True, "add | list."),
           _pos("title", False, "add: the gap title."), _F_CONTEXT], False),
