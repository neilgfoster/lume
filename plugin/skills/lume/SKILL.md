...
- Cross-repo capability gaps live in `.lume/gaps/<source>-G<nnnn>-<stub>.json` (numeric id zero-padded in the filename for sequential sort, slugified title hint; the gap id itself stays `G<n>`). Gaps are
